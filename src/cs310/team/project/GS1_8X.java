...
public class GS1_8X extends GS1 {
    ...
    public GS1_8X() {
        ...
        super.matchers.put("8003" , Pattern.compile("^8003[0-9]{14}[0-9]{4}[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,16}[%\\x1D]"));
        ...
        super.matchers.put("8003eol" , Pattern.compile("^8003[0-9]{14}[0-9]{4}[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,16}$"));
