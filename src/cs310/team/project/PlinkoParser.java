...
// <editor-fold desc="Application Identifier Pattern Matchers">
        ...
        Pattern p8003 = Pattern.compile("^8003[0-9]{14}[0-9]{4}(.){1,16}[%\\x1D]");
        Pattern p8004 = Pattern.compile("^8004(.){1,30}[%\\x1D]");
        Pattern p8005 = Pattern.compile("^8005[0-9]{6}[%\\x1D]");
        Pattern p8006 = Pattern.compile("^8006[0-9]{4}[0-9]{14}[0-9]{2}[0-9]{2}[%\\x1D]");
        Pattern p8007 = Pattern.compile("^8007(.){1,34}[%\\x1D]");
        Pattern p8008 = Pattern.compile("^8008[0-9]{4}[0-9]{8}[0-9]{1,4}[%\\x1D]");
        ...
        Pattern p8019 = Pattern.compile("^8019[0-9]{1,10}[%\\x1D]");
        Pattern p8020 = Pattern.compile("^8020(.){1,25}[%\\x1D]");
        Pattern p8026 = Pattern.compile("^8026[0-9]{4}[0-9]{14}[0-9]{2}[0-9]{2}[%\\x1D]");
        ...
        Pattern p8003eol = Pattern.compile("^8003[0-9]{14}[0-9]{4}(.){1,16}$");
        Pattern p8004eol = Pattern.compile("^8004(.){1,30}$");
        Pattern p8005eol = Pattern.compile("^8005[0-9]{6}$");
        Pattern p8006eol = Pattern.compile("^8006[0-9]{4}[0-9]{14}[0-9]{2}[0-9]{2}$");
        Pattern p8007eol = Pattern.compile("^8007(.){1,34}$");
        Pattern p8008eol = Pattern.compile("^8008[0-9]{4}[0-9]{8}[0-9]{1,4}$");
        ...
        Pattern p8019eol = Pattern.compile("^8019[0-9]{1,10}$");
        Pattern p8020eol = Pattern.compile("^8020(.){1,25}$");
        Pattern p8026eol = Pattern.compile("^8026[0-9]{4}[0-9]{14}[0-9]{2}[0-9]{2}$");
