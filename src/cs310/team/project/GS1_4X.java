...
<<<<<<< HEAD
        ...
        super.matchers.put("421", Pattern.compile("^420[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]{1,20}$"));
...
=======
        super.matchers.put("427", Pattern.compile("^427[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]
{1,3}[%\\x1D]"));
        super.matchers.put("427eol", Pattern.compile("^427[!\"&'()*+,\\-./0-9:;<=>?A-Z_a-z]
{1,3}$"));
>>>>>>> bd8b55710dfe4debf02baa807a90d44693c29544
